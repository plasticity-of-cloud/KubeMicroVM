...
import com.amazonaws.lambda.operator.controller.reconciler.MicroVMReconciler;
...
class MicroVMReconcilerTest {
    ...
    void pendingToRunningOnAwsSuccess() {
        ...
        assertInstanceOf(com.amazonaws.lambda.operator.core.state.StateTransitionResult.Valid.class, transition);
    ...
    void deletionTriggersTermination() {
        ...
        assertInstanceOf(com.amazonaws.lambda.operator.core.state.StateTransitionResult.Valid.class, t1);

        var t2 = stateMachine.transition(MicroVMState.TERMINATING, MicroVMState.TERMINATED);
        assertInstanceOf(com.amazonaws.lambda.operator.core.state.StateTransitionResult.Valid.class, t2);
